...
fun PowerScreen() {
    DataTypeScreen(
        ...
        groupedAggregatedContent = { records ->
            ...
            Text("A slice has an average of: ${records.sumOf { it.avg.inWatts } / records.size} Watts")
            Text("The slices have a total average of: ${records.sumOf { it.avg.inWatts }} Watts")
